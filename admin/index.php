        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="index.php?modulo=estadisticas" class="nav-link active">
                  <i class="fas fa-chart-bar nav-icon"></i>
                  <p>Statistics</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?modulo=product" class="nav-link">
                  <i class="fa fa-shopping-bag nav-icon" aria-hidden="true"></i>
                  <p>Product</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?modulo=customer" class="nav-link">
                  <i class="far fa-user nav-icon"></i>
                  <p>Customer</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?modulo=sale" class="nav-link">
